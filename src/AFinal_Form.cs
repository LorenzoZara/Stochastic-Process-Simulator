...
{
    public partial class AFinal_Form : Form
    {
        ...
        public double sig;
        public int lam;
        public int b;        // elasticity parameter < 0
        ...
        private void initialize()
        {
            ...
            for (int i = 0; i < m; i++)
            {
                ...
                values.Add(values_i);
                paths.Add(new WalkingPath(values_i, mi, sig, startingPoint, lam, PC));
            }
        }
        ...
        private void draw()
        {
            ...
            try
            {
                ...
                GE.drawLandscapeHistogram(graphics, pictureBox, viewPort, //to specting point
                    PC.getSpecificWalkingDistributionNeg(paths, 3 * SCALE, j), n, j, minimumY, maximumY, 4);
                GE.drawLandscapeHistogram(graphics, pictureBox, viewPort, //to final point
                    PC.getSpecificWalkingDistributionNeg(paths, 3 * SCALE, n - 1), n, n, minimumY, maximumY, 4);
        ...
        public AFinal_Form()
        {
            ...
            m = noPaths_trackbar.Value = 3;
            n = noPoints_trackbar.Value = 365;
            ...
            lam = poisson_trackbar.Value = 1;
            startingPoint = startingPoint_trackbar.Value;
            ...
            poisson_label.Text = "λ = " + lam.ToString();
            startingPoint_label.Text = "y = " + startingPoint.ToString();
        ...
        private void scale_checkBox_CheckedChanged(object sender, EventArgs e)
        {
            draw();
        }

        private void startingPoint_trackbar_MouseUp(object sender, MouseEventArgs e)
        {
            startingPoint = startingPoint_trackbar.Value;
            startingPoint_label.Text = "y = " + startingPoint.ToString();
            initialize();
        ...
        private void poisson_trackbar_MouseUp(object sender, MouseEventArgs e)
        {
            lam = poisson_trackbar.Value;
            poisson_label.Text = "λ = " + lam.ToString();
            initialize();
            draw();
        }
