...
{
    public partial class A22V_Form : Form
    {
        ...
        private void initialize()
        {
            ...
            for (int i = 0; i < m; i++)
            {
                ...
                values.Add(values_i);
                paths.Add(new WalkingPath(values_i, 0.5, mi, sig, "arithmetic", 100));
            }
        }
        ...
        private void draw()
        {
            ...
            GE.drawLandscapeHistogram(graphics, pictureBox, viewPort, //to specting point
                PC.getSpecificWalkingDistribution(paths, 30 * SCALE, j), n, j, minimumY, maximumY, 1);
            GE.drawLandscapeHistogram(graphics, pictureBox, viewPort, //to final point
                PC.getSpecificWalkingDistribution(paths, 30 * SCALE, n - 1), n, n, minimumY, maximumY, 1);
