...
{
    public partial class ACIR : Form
    {
        ...
        private void initialize()
        {
            ...
            for (int i = 0; i < m; i++)
            {
                ...
                values.Add(values_i);
                paths.Add(new WalkingPath(values_i, 0.5, mi, sig, "geometric", startingPoint)); // HARDCODED STARTING POINT
                //CEV paths.Add(new WalkingPath(values_i, mi, sig, b, 15));
            }
        }
        ...
        public ACIR()
        {
            ...
            startingPoint = startingPoint_trackbar.Value = 100;
